...
A beginner-friendly clone of the Amazon website built using only HTML and CSS (no JavaScript). This project focuses on layout, structure, and styling to recreate common e-commerce UI patterns for learning and demonstration purposes.
...
1. Clone the repository:
   git clone https://github.com/AmithDongre/amazon-clone.git
2. Open `index.html` in your web browser:
   - On most systems you can double-click the file or open it from your browser (File → Open File).
...
- Layout and styling similar to an e-commerce storefront (header, product grid, product cards, footer)
...
- Open `index.html` in a browser to view the static pages.
...
- Add responsive breakpoints to improve mobile layout.
...
- Design and layout inspiration taken from common e-commerce patterns.
- Helpful resources: MDN Web Docs, CSS-Tricks, and other web development tutorials.
